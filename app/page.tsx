...
export default function Home() {
  return (
    <main className="h-screen overflow-y-auto overflow-x-hidden overscroll-none relative bg-[#4169E1] font-sans">
      {/* Logo at Top */}
      <div className="absolute z-50 top-4 left-1/2 -translate-x-1/2 md:top-8">
        <style>{`
          @keyframes zoomIn {
      ...
      <div className="relative flex flex-col md:flex-row min-h-screen w-full">
        ...
        {/* CENTER WHITE BOX - Positioned absolutely for overlap (mobile & desktop) */}
        <div className="absolute z-40 w-[80%] max-w-[280px] left-1/2 top-[53%] -translate-x-1/2 -translate-y-1/2 mx-auto my-0 md:w-auto">
