    ...
    >
      ...
      >
        <div className="relative w-full max-w-5xl overflow-hidden rounded-[20px] bg-white shadow-2xl">
          ...
          <div className="relative w-full aspect-[4/3] bg-black sm:aspect-[16/10]">
            <img
              src={src}
              alt={alt}
...
export default function AepgosingPage() {
  ...
  const metrics = useMemo(
    () => [
      ...
      {
        label: "Smart Hub Utilization",
        value: "Pilot Validation",
      },
      {
        label: "Commodity Throughput",
        value: "Tonnes Handled",
      },
      {
        label: "Trade Transactions Digitized",
        value: "Volume & Value",
      },
      {
        label: "Active Trade Network",
        value: "Traders & Buyers",
      },
      {
        label: "Ground-Truth Data Generated",
    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="mt-12 mb-4 flex flex-wrap items-center justify-center gap-3">
          ...
          <div className="relative rounded-full border border-gray-100 bg-white/80 px-4 py-2 text-center text-xs text-black/100 shadow-sm">
            ...
            <span className="relative font-bold">
              A subsidiary of Fatamid International Ltd
            </span>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative z-10 flex h-full items-center justify-center">
            <div className="px-4 text-center text-white">
              ...
              <p className="mt-4 max-w-4xl text-xl text-white/95 sm:text-2xl">
                AEPGo transforms fragmented agricultural trade by connecting
                physical Smart Hubs, ground-truth trade data, geospatial
                intelligence, and AI to reduce losses and improve how
                commodities are preserved, moved, and traded.
              </p>

              <div className="mt-8 inline-flex items-center gap-3 rounded-full border border-white/20 bg-white/15 px-5 py-3 backdrop-blur">
        ...
        <div className="mt-10 px-4 text-center">
          <a
            ...
            className="bottom-4 left-4 ml-2 rounded-full bg-black/90 px-4 py-2 text-sm font-semibold text-gold-90 shadow-sm hover:opacity-90"
          >
        ...
        <div className="mt-10 grid items-start gap-8 lg:grid-cols-3">
          ...
          >
            <div className="sticky top-24">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Key conditions supporting Smart Hub deployment, trade adoption,
                and network growth.
              </p>
              ...
              <div className="mt-6 rounded-3xl border border-gray-100 bg-white/80 p-6 shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-sm font-semibold text-gray-900">
                    Strong Trader & Aggregator Adoption
                  </div>
                </div>
                ...
                <div className="mt-4 flex items-center gap-3">
                  ...
                  <div className="text-sm font-semibold text-gray-900">
                    Sufficient Commodity Throughput
                  </div>
                </div>
                ...
                <div className="mt-4 flex items-center gap-3">
                  ...
                  <div className="text-sm font-semibold text-gray-900">
                    Strong Demand for Verified Supply
                  </div>
                </div>
                ...
                <div className="mt-4 flex items-center gap-3">
                  ...
                  <div className="text-sm font-semibold text-gray-900">
                    Technology & Infrastructure Remain Affordable
                  </div>
                </div>
                ...
                <div className="mt-4 flex items-center gap-3">
                  ...
                  <div className="text-sm font-semibold text-gray-900">
                    Strategic Partnerships Enable Network Growth
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <p className="mt-2 text-sm text-gray-600">
              Key indicators for validating infrastructure performance, trade
              adoption, data generation, and network growth.
            </p>
